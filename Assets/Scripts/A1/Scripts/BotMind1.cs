...
{
    /// <summary>
    /// The state that Bot1 enters.
    /// </summary>
    [CreateAssetMenu(menuName = "A1/Scripts/Bot", fileName = "Bot Mind 1")]
    public class BotMind1 : State
    {
        public override void Execute(Agent agent)
        {
            ...
            Transform tile = agent.Sense<BotSensor1, Transform>();
