...
namespace A1
{
    ...
    public class BotManager : Manager
    {
        ...
        private static void GenerateFloor()
        {
            ...
            if (BotSingleton._cleanerAgent != null)
            {
        ...
        private static void UpdateFloor()
        {
            ...
            if (BotSingleton._elapsedTime < BotSingleton.timeBetweenDirtGeneration)
            {
                return;
            }
        ...
        private static void SetFloorTiles()
        {
            ...
            do
            {
                ...
                foreach (Floor floor in BotSingleton._floors.Where(f => f.State != Floor.DirtLevel.ExtremelyDirty))
                {
